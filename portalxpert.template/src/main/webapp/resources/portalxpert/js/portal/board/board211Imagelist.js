	...
	var fnDoAutoIframeResize = function(){
		...
		var iFrames = parent.document.getElementById("bbs211Frame");
	...
	function fnFormBbsImgBoardNotiList(pageNo)
	{
		...
		//document.listForm.searchCondition.value = $("#searchCondition").val();
		
		document.listForm.action = WEB_HOME+"/board211/getBbsImgBoardNotiList.do";
...
////////////////////////////////onload/////////////////////////////////////////////////////////////////////	
	...
	$(document).ready(function () { 
		...
		$('.btn_write').click(function() {//글쓰기
			location.href = WEB_HOME+"/board230/board230Write.do?boardId="+ boardId+"&kind=BBS&pageUnit=6";
		});
