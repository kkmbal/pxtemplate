	...
	function fnGetRegView(userId){
		PortalCommon.popupWindowCenter(WEB_HOME+'/adm/sys/getAdmSysUserManage.do?userId='+userId, '사용자',900,320);
	}
...
$(document).ready(function () {
	...
	$('#createUser').click(function() {//등록
		PortalCommon.popupWindowCenter(WEB_HOME+'/adm/sys/getAdmSysUserManage.do?userId=', '사용자',900,320);
	});	
