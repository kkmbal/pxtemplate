package portalxpert.board.board212.sc.impl;
...
import portalxpert.board.board212.mapper.Board212Mapper;
...
public class Board212ServiceImpl extends EgovAbstractServiceImpl implements  Board212Service {
    ...
    /** board212Mapper */
    @Resource(name="board212Mapper")
    private Board212Mapper board212Mapper;
