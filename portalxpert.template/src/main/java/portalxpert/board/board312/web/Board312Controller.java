package portalxpert.board.board312.web;
...
@Controller
@RequestMapping(value = "board312")
public class Board312Controller {
	
	/** boardService */
    @Resource(name = "board300Service")
    private Board300Service board300Service;
	/** person100Service */
	@Resource(name = "board312Service")
	private Board312Service board312Service;
	...
	private final static Logger logger = LoggerFactory.getLogger(Board312Controller.class);
	...
	public String pageFowarding(
	   	...
	   	{	
	   		...
	   		fowardUrl = ".board/board/bbs312Frame";					 
	 ...
	 * @author 
	 */
	@RequestMapping(value="/getPbsVideoBoardNotiList")                            
	 public String getPbsVideoBoardNotiList(
			 ModelMap modelMap,
				...
				List noti_list = board312Service.getPbsNotiUserInfoListForPaging(boardSearchVO);//게시글 조회
				int totCnt = board312Service.getPbsUserNotiInfoListTotCnt(boardSearchVO);
	        ...
	        return ".self/pbs/pbs312Videolist";
	 ...
	 * @author 
	 */
	@RequestMapping(value = "/updateVideoNotiInfo", method = RequestMethod.POST)
	public ModelMap updateVideoNotiInfo(
		...
		try {
			...
			board312Service.updateImgNotiInfo(data, session);
	...
	public ModelMap getBbsNotiList(
		...
		JSONResult jsonResult = new JSONResult();
	 	try {
	 		...
	 		List<BbsImgBoardNotiInfoVO> bbsNotiList = board312Service.getBbsNotiList(boardId);
