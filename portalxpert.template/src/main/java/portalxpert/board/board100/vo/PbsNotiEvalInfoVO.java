...
public class PbsNotiEvalInfoVO {
	private String userNotiSeq;
	private String notiEvalDiv;
	...
	public String getUserNotiSeq() {
		return userNotiSeq;
	}
	public void setUserNotiSeq(String userNotiSeq) {
	...
	public String getNotiEvalDiv() {
		return notiEvalDiv;
	}
	public void setNotiEvalDiv(String notiEvalDiv) {
		this.notiEvalDiv = notiEvalDiv;
	}
