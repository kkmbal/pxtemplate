...
public class PsnTmlnInfoVO {
	...
	private int tmlnSeq; //타임라인_일련번호
	private int upTmlnSeq; //상위_타임라인_일련번호
	private String objrDiv; //대상자_구분
	private String userId; //사용자_아이디
	private String userNick; //사용자_닉네임
	private String userName; //사용자_명
	private String tmlnDiv; //타임라인_구분
	private String tmlnKind; //타임라인_종류
	private String tmlnTitle; //타임라인_제목
	private String tmlnConts; //타임라인_내용
	private String tmlnSrc; //타임라인_출처
	private String relaUrl; //연계_URL
	private int opnCnt; //의견_건수
	private int agrmCnt; //찬성_건수
	private int oppCnt; //반대_건수
	private int likeCnt; //좋아요_건수
