package portalxpert.board.board211.vo;

import portalxpert.common.vo.SearchConditionVO;

public class BbsImgBoardNotiInfoVO extends SearchConditionVO{
	...
	public String getApndImage() {
		return apndImage;
	}
	public void setApndImage(String apndImage) {
		this.apndImage = apndImage;
	}
