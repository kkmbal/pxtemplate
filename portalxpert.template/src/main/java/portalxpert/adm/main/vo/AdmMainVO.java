package portalxpert.adm.main.vo;

public class AdmMainVO {
	...
	public int getStndCntsSeq() {
		return stndCntsSeq;
	}
	public void setStndCntsSeq(int stndCntsSeq) {
		this.stndCntsSeq = stndCntsSeq;
	}
